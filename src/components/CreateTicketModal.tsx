        ...
        <div className="p-8">
          ...
          <div className="mb-5">
            ...
            <textarea
              ...
              rows={3}
              className="airbnb-input w-full resize-none"
            />
          </div>
          ...
          <div className="mb-8 relative">
            ...
            <button
              ...
              className="airbnb-input w-full flex items-center justify-between text-left"
            >
              {assignee ? (
            ...
            <AnimatePresence>
              {showAssigneeDropdown && (
                <motion.div
                  ...
                  exit={{ opacity: 0, y: -4 }}
                  className="absolute top-full left-0 right-0 mt-2 bg-card border border-border rounded-2xl shadow-xl z-10 max-h-[240px] overflow-y-auto"
                >
                  {teamMembers.map((member) => (
                    <button
                      ...
                      className="w-full flex items-center gap-3 px-4 py-3 hover:bg-secondary transition-colors first:rounded-t-2xl last:rounded-b-2xl"
                    >
                      <div
