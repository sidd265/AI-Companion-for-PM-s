          ...
          <div key={integration.id} className="airbnb-card p-6">
            ...
            {integration.connected ? (
              <>
                ...
                <button onClick={() => setActiveDrawer(integration.id)} className="airbnb-btn-secondary flex items-center gap-2 py-2 px-4 rounded-full text-sm">
                  <Settings className="w-4 h-4" />Manage
                </button>
              </>
            ) : (
              <button onClick={() => setActiveDrawer(integration.id)} className="airbnb-btn-pill flex items-center gap-2 py-2.5 px-5 text-sm">
