  ...
  theme: {
    ...
    extend: {
      ...
      fontSize: {
        ...
        "notion-h1": ["30px", { lineHeight: "1.2", fontWeight: "700" }],
        "notion-h2": ["24px", { lineHeight: "1.3", fontWeight: "600" }],
        "notion-h3": ["18px", { lineHeight: "1.4", fontWeight: "600" }],
        "notion-body": ["16px", { lineHeight: "1.5", fontWeight: "400" }],
        "notion-small": ["14px", { lineHeight: "1.5", fontWeight: "400" }],
        "notion-tiny": ["12px", { lineHeight: "1.4", fontWeight: "400" }],
      },
      spacing: {
        "notion-micro": "4px",
        "notion-small": "8px",
